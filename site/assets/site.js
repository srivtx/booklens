/* booklens — progressive enhancement only.
   The page is fully readable with JavaScript disabled. Nothing here makes a
   network request. It also exposes an offline EPUB sample builder for the
   playground, so the sample is generated in memory rather than fetched. */
(function () {
  "use strict";
  ...
  /* ----- Offline sample EPUB --------------------------------------------
     ...
     to call on the "Audit the sample book" button. */
